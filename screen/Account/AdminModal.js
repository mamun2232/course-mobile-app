        ...
        <AlertDialog.Content>
          ...
          <AlertDialog.Body>
            ...
            <View className="mt-2">
              <VStack space={6} alignSelf="flex-start" w="100%">
                ...
                >
                  <Select.Item label="Please Select Role" value="Please Select Role" />
          ...
          <AlertDialog.Footer>
            <>
              ...
              <Button className="w-full bg-orange-600 text-white" colorScheme="danger" onPress={()=>makeUserAdminHendeler()}>
                Make Admin
              </Button>
            </>
          </AlertDialog.Footer>
